...
INSERT INTO products (category_id, name, description, price, margin_amount, pv_value, brand, manufacturer, supplier, attributes) VALUES
(1, 'Fiery Chilli Crisps', 'Our OG. Recklessly spicy, dangerously addictive crisps made with Guntur chillies.', 49.00, 15.00, 1.50, 'Luttu', 'Luttu Kitchens', 'Direct Farmer Sourcing', '{"Spice Level": "Fiery Hot", "Weight": "100g", "Main Ingredient": "Rice Flour"}'),
(2, 'Caramel Popcorn', 'Gourmet popcorn coated in rich, buttery sea-salt caramel.', 65.00, 20.00, 2.00, 'Luttu', 'Luttu Kitchens', 'Karnataka Corn Farms', '{"Sugar Content": "Medium", "Flavor": "Caramel", "Weight": "150g"}'),
(3, 'Cheesy Puff Rings', 'Air-puffed corn rings with a double layer of aged cheddar cheese powder.', 55.00, 18.00, 1.80, 'Luttu', 'Luttu Kitchens', 'Dairy Co-op', '{"Texture": "Extra Crunchy", "Oil Used": "Sunflower Oil", "Weight": "120g"}'),
(4, 'Truffle Chips XO', 'Premium potato chips infused with black truffle oil and sea salt.', 99.00, 35.00, 3.50, 'Luttu', 'Premium Line', 'Global Imports', '{"Salt Type": "Sea Salt", "Weight": "80g"}'),
(1, 'Lemon Pepper Stix', 'Tangy lemon meets bold black pepper in these crunchy corn stix.', 45.00, 12.00, 1.20, 'Luttu', 'Luttu Kitchens', 'Local Spices', '{"Spice Level": "Mild", "Weight": "100g", "Main Ingredient": "Corn"}');
